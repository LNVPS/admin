...
export function EditPricingModal({ isOpen, onClose, onSuccess, pricing }: EditPricingModalProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    cpu_cost: fromSmallestUnits(pricing.cpu_cost, pricing.currency),
    memory_cost: fromSmallestUnits(pricing.memory_cost, pricing.currency),
    ip4_cost: fromSmallestUnits(pricing.ip4_cost, pricing.currency),
    ip6_cost: fromSmallestUnits(pricing.ip6_cost, pricing.currency),
    ...
    disk_pricing: pricing.disk_pricing.map((disk) => ({
      ...
      cost: fromSmallestUnits(disk.cost, pricing.currency),
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Edit Custom Pricing Model" size="3xl">
        ...
        <div>
          ...
          <div className="space-y-3">
            {formData.disk_pricing.map((disk, index) => (
              <div key={index} className="grid grid-cols-1 md:grid-cols-6 gap-x-2 p-3 bg-slate-700 rounded-md">
